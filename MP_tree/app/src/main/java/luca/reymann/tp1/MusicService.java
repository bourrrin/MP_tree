...
public class MusicService extends Service {
    ...
    private android.media.MediaPlayer diffuseur; //diffuseur
    ...
    public void onCreate() {
        super.onCreate();
        diffuseur = new android.media.MediaPlayer(); // crée le MediaPlayer
        initMusicPlayer();
    }
    ...
    //méthode peut être utile avec la SeekBar
